...
public class HSMDataGenRead {
    ...
    public static String inputDoor1 = System.getProperty("user.dir") + "/HSM/topology/door_final.txt";
    public static String inputRoom1 = System.getProperty("user.dir") + "/HSM/topology/par_final.txt";
    ...
    public void dataGen(String dataset) throws IOException {
        ...
        while (scanner1.hasNextLine()) {
            ...
            double x1 = Double.parseDouble(tempArr[1]) * DataGenConstant.zoom_HSM;
            double y1 = Double.parseDouble(tempArr[3]) * DataGenConstant.zoom_HSM;
            double x2 = Double.parseDouble(tempArr[2]) * DataGenConstant.zoom_HSM;
            double y2 = Double.parseDouble(tempArr[4]) * DataGenConstant.zoom_HSM;
...
//            System.out.println("doorId: " + doorId);
            double x = Double.parseDouble(tempArr[1]) * DataGenConstant.zoom_HSM;
            double y = Double.parseDouble(tempArr[2]) * DataGenConstant.zoom_HSM;
