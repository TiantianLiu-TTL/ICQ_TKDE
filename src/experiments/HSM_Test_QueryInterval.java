...
public class HSM_Test_QueryInterval {
    public static String dataset = "HSM";
    public static double probabilityThreshold = 0.5;

//    public static String result_pre_queryInterval_icqBase = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_queryInterval_icqBase.txt";
...
//    public static String result_pre_queryInterval_icqPre = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_queryInterval_icqPre.txt";
    ...
    public static void run(String outFileTime, String outFileMemory) throws IOException {
        ...
        ArrayList<Integer> endTimes = new ArrayList<>(Arrays.asList(21600, 21600, 43200, 64800, 86400));
...
//        try {
//            FileWriter output = new FileWriter(result_pre_queryInterval_icqBase);
//            output.write(s0);
//            output.flush();
//            output.close();
//        } catch (IOException e) {
...
//
//        try {
//            FileWriter output = new FileWriter(result_pre_queryInterval_icqPre);
//            output.write(s2);
//            output.flush();
//            output.close();
//        } catch (IOException e) {
