...
public class Acc_QueryInterval {
    static String dataset = "syn";

    static double probabilityThreshold = 0.5;
    public static String result_true_queryInterval = System.getProperty("user.dir") + "/result/result_" + dataset + "_true_queryInterval.txt";
    public static String result_pre_queryInterval_icq = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_queryInterval_icq.txt";
//    public static String result_pre_queryInterval_icq_base = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_queryInterval_icqBase.txt";
    public static String result_pre_queryInterval_icq_base_new = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_queryInterval_icqBaseNew.txt";
    public static String result_pre_queryInterval_icq_base_unseen = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_queryInterval_icqBaseUnseen.txt";


    public static String outFilePrecision = System.getProperty("user.dir") + "/result/" + dataset + "_queryInterval_precision.csv";
    public static String outFileRecall = System.getProperty("user.dir") + "/result/" + dataset + "_queryInterval_recall.csv";
    public static String outFileF = System.getProperty("user.dir") + "/result/" + dataset + "_queryInterval_F.csv";
...
//        PreCompute.preInfo_read(dataset, 4000, DataGenConstant.sample_dist);
        ...
        ArrayList<Integer> endTimes = new ArrayList<>(Arrays.asList(21600, 43200, 64800, 86400));
        String s = "";

        for (int i = 0; i < endTimes.size(); i++) {
            DataGenConstant.endTime = endTimes.get(i);
            System.out.println("endTime: " + DataGenConstant.endTime / 3600);

            s += DataGenConstant.endTime / 3600;
        ...
        try {
            FileWriter output = new FileWriter(result_true_queryInterval);
            output.write(s);
            output.flush();
            output.close();
        } catch (IOException e) {
    ...
    public static void calAccuracy() throws IOException {
        String resultPrecision = "queryInterval" + "\t" + "icq" + "\t" + "icq_baseNew"+ "\t" + "icq_baseUnseen" + "\n";
        String resultRecall = "queryInterval" + "\t" + "icq" + "\t" + "icq_baseNew"+ "\t" + "icq_baseUnseen" + "\n";
        String resultF = "queryInterval" + "\t" + "icq" + "\t" + "icq_baseNew"+ "\t" + "icq_baseUnseen" + "\n";

        Path path = Paths.get(result_true_queryInterval);
        Scanner scanner = new Scanner(path);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> queryInterval_true_map = new HashMap<>();
        while (scanner.hasNextLine()) {
            String line = scanner.nextLine();
            String [] tempArr1 = line.split("\t");
            int queryInterval = Integer.parseInt(tempArr1[0]);
            ...
            queryInterval_true_map.put(queryInterval, tra_map);
        }

        Path path1 = Paths.get(result_pre_queryInterval_icq);
        Scanner scanner1 = new Scanner(path1);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> queryInterval_icq_map = new HashMap<>();
        while (scanner1.hasNextLine()) {
            ...
            queryInterval_icq_map.put(queryInterval, tra_map);
        }

        Path path2 = Paths.get(result_pre_queryInterval_icq_base_new);
        Scanner scanner2 = new Scanner(path2);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> queryInterval_icqBaseNew_map = new HashMap<>();
        while (scanner2.hasNextLine()) {
            ...
            queryInterval_icqBaseNew_map.put(queryInterval, tra_map);
        }

        Path path3 = Paths.get(result_pre_queryInterval_icq_base_unseen);
        Scanner scanner3 = new Scanner(path3);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> queryInterval_icqBaseUnseen_map = new HashMap<>();
        while (scanner3.hasNextLine()) {
            ...
            queryInterval_icqBaseUnseen_map.put(queryInterval, tra_map);
        }
        ...
        for (int endTime: endTimes) {
            resultF += endTime / 3600;
            resultRecall += endTime / 3600;
            resultPrecision += endTime / 3600;

            System.out.println("endTime: " + endTime / 3600);
            ...
            HashMap<Integer, HashMap<Integer, Double>> tra_icq_map = queryInterval_icq_map.get(endTime / 3600);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseNew_map = queryInterval_icqBaseNew_map.get(endTime / 3600);
            HashMap<Integer, HashMap<Integer, Double>> tra_true_map = queryInterval_true_map.get(endTime / 3600);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseUnseen_map = queryInterval_icqBaseUnseen_map.get(endTime / 3600);

            System.out.println("tra_icq_map size: " + tra_icq_map.size());
            System.out.println("tra_icqBaseNew_map size: " + tra_icqBaseNew_map.size());
            System.out.println("tra_true_map size: " + tra_true_map.size());
            System.out.println("tra_icqBaseUnseen_map size: " + tra_icqBaseUnseen_map.size());
            ...
            for (int i = 0; i < trajectorys.size(); i++) {
                ...
                System.out.println("icqBaseNew_map size: " + icqBaseNew_map.size());
                System.out.println("true_map size: " + true_map.size());
                System.out.println("icqBaseUnseen_map size: " + icqBaseUnseen_map.size());
