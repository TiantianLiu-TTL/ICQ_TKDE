...
public class Test_ObjectNum {
    public static double probabilityThreshold = 0.5;
    public static int objectNum = 10000;
    public static String dataset = "syn";

    public static String result_pre_objectNum_icq_naive = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_objectNum_icqNaive.txt";
...
//    public static String result_pre_objectNum_icq_base = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_objectNum_icqBase.txt";
    ...
    public static void run(String outFileTime, String outFileMemory) throws IOException {
        String resultTime = "objectNum" + "\t" + "icq_naive" +  "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        String resultMemo = "objectNum" + "\t" + "icq_naive" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        ...
        resultTime += objectNum + "\t";
        resultMemo += objectNum + "\t";
...
//                    Algo_ICQ_baseline_unseen.icq_baseline_unseen_clear();
        ...
        try {
            FileWriter output = new FileWriter(result_pre_objectNum_icq_naive, true);
            output.write(s0);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_objectNum_icq, true);
            output.write(s1);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_objectNum_icq_base_new, true);
            output.write(s2);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_objectNum_icq_base_unseen, true);
            output.write(s3);
            output.flush();
            output.close();
        } catch (IOException e) {
    ...
    public static void main(String arg[]) throws IOException {
        ...
        TrajectoryGen.trajectoryGen_read(TrajectoryGen.trajectoryPoints, TrajectoryGen.trajectorys, dataset, objectNum, false);
//        PreCompute.preInfo_read(dataset, objectNum, DataGenConstant.sample_dist);


        // objectNum
        String outFileTime = System.getProperty("user.dir") + "/result/" + dataset + "_objectNum_time.csv";
        String outFileMemory = System.getProperty("user.dir") + "/result/" + dataset + "_objectNum_memory.csv";
