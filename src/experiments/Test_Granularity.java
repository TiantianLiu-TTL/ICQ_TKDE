...
public class Test_Granularity {
    public static double probabilityThreshold = 0.5;
    public static String dataset = "syn";

    public static String result_pre_granularity_icq_naive = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_granularity_icqNaive.txt";
...
//                    Algo_ICQ_baseline_unseen.icq_baseline_unseen_clear();
        ...
        try {
            FileWriter output = new FileWriter(result_pre_granularity_icq_naive);
            output.write(s0);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_granularity_icq);
            output.write(s1);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_granularity_icq_base_new);
            output.write(s2);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_granularity_icq_base_unseen);
            output.write(s3);
            output.flush();
            output.close();
        } catch (IOException e) {
