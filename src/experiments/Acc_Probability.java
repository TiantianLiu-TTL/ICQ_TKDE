...
public class Acc_Probability {
    static String dataset = "syn";

    static double probabilityThreshold = 0.5;
    public static String result_true_probability = System.getProperty("user.dir") + "/result/result_" + dataset + "_true_probability.txt";
    public static String result_pre_probability_icq = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_probability_icq.txt";
//    public static String result_pre_probability_icq_base = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_probability_icqBase.txt";
    public static String result_pre_probability_icq_base_new = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_probability_icqBaseNew.txt";
    public static String result_pre_probability_icq_base_unseen = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_probability_icqBaseUnseen.txt";


    public static String outFilePrecision = System.getProperty("user.dir") + "/result/" + dataset + "_probability_precision.csv";
    public static String outFileRecall = System.getProperty("user.dir") + "/result/" + dataset + "_probability_recall.csv";
    public static String outFileF = System.getProperty("user.dir") + "/result/" + dataset + "_probability_F.csv";
...
//        PreCompute.preInfo_read(dataset, 4000, DataGenConstant.sample_dist);
        ...
        ArrayList<Double> probabilitys = new ArrayList<>(Arrays.asList(0.3, 0.4, 0.5, 0.6, 0.7));
        String s = "";
    ...
    public static void calAccuracy() throws IOException {
        String resultPrecision = "probability" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        String resultRecall = "probability" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        String resultF = "probability" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";

        Path path = Paths.get(result_true_probability);
        Scanner scanner = new Scanner(path);

        HashMap<Double, HashMap<Integer, HashMap<Integer, Double>>> probability_true_map = new HashMap<>();
        ...
        Path path1 = Paths.get(result_pre_probability_icq);
        Scanner scanner1 = new Scanner(path1);

        HashMap<Double, HashMap<Integer, HashMap<Integer, Double>>> probability_icq_map = new HashMap<>();
        while (scanner1.hasNextLine()) {
            ...
            probability_icq_map.put(probability, tra_map);
        }

        Path path2 = Paths.get(result_pre_probability_icq_base_new);
        Scanner scanner2 = new Scanner(path2);

        HashMap<Double, HashMap<Integer, HashMap<Integer, Double>>> probability_icqBaseNew_map = new HashMap<>();
        while (scanner2.hasNextLine()) {
            ...
            probability_icqBaseNew_map.put(probability, tra_map);
        }

        Path path3 = Paths.get(result_pre_probability_icq_base_unseen);
        Scanner scanner3 = new Scanner(path3);

        HashMap<Double, HashMap<Integer, HashMap<Integer, Double>>> probability_icqBaseUnseen_map = new HashMap<>();
        while (scanner3.hasNextLine()) {
            ...
            probability_icqBaseUnseen_map.put(probability, tra_map);
        }
        ...
        for (double probability: probabilitys) {
            resultF += probability;
            resultRecall += probability;
            resultPrecision += probability;
            ...
            HashMap<Integer, HashMap<Integer, Double>> tra_icq_map = probability_icq_map.get(probability);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseNew_map = probability_icqBaseNew_map.get(probability);
            HashMap<Integer, HashMap<Integer, Double>> tra_true_map = probability_true_map.get(probability);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseUnseen_map = probability_icqBaseUnseen_map.get(probability);
                ...
                for (int true_parId: true_list) {
                    for (int icq_parId: icq_list) {
                        if (icq_parId == true_parId) {
                            num1++;
//                            System.out.println("error1: " + Math.abs(true_map.get(true_parId) - icq_map.get(icq_parId)));
//                            error1 += Math.abs(true_map.get(true_parId) - icq_map.get(icq_parId));
                    ...
                    for (int icq_parId: icqBaseNew_list) {
                        if (icq_parId == true_parId) {
                            num2++;
//                            System.out.println("error2: " + Math.abs(true_map.get(true_parId) - icqBase_map.get(icq_parId)));
...
//                }
//                else {
//                    System.out.println("error sum1: " + error1);
//                    error1 = error1 / num1;
//                    System.out.println("error ave1: " + error1);
//                    acc1 = 1 - error1;
...
//                }
                ...
                System.out.println("precision3: " + precision3 + " recall2: " + recall3);
...
//            System.out.println("precisionList: " + precisionList);
//            System.out.println("recallList: " + recallList);
