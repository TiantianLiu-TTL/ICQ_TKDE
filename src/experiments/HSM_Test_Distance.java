...
public class HSM_Test_Distance {
...
//    public static String result_pre_distance_icqPre = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_distance_icqPre.txt";
    ...
    public static void run(String outFileTime, String outFileMemory) throws IOException {
        String resultTime = "distance" + "\t" + "icq_naive" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        String resultMemo = "distance" + "\t" + "icq_naive" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        ...
        ArrayList<Integer> distances = new ArrayList<>(Arrays.asList(1, 1, 2, 3, 4, 5));
