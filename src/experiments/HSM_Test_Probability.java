...
public class HSM_Test_Probability {
    public static String dataset = "HSM";

//    public static String result_pre_probability_icqBase = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_probability_icqBase.txt";
...
//    public static String result_pre_probability_icqPre = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_probability_icqPre.txt";
    ...
    public static void run(String outFileTime, String outFileMemory) throws IOException {
        ...
        ArrayList<Double> probabilitys = new ArrayList<>(Arrays.asList(0.3, 0.3, 0.4, 0.5, 0.6, 0.7));
...
//        try {
//            FileWriter output = new FileWriter(result_pre_probability_icqBase);
//            output.write(s0);
//            output.flush();
//            output.close();
//        } catch (IOException e) {
...
//
//        try {
//            FileWriter output = new FileWriter(result_pre_probability_icqPre);
//            output.write(s2);
//            output.flush();
//            output.close();
//        } catch (IOException e) {
