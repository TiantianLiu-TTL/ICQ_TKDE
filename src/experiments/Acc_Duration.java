...
public class Acc_Duration {
    static String dataset = "syn";

    static double probabilityThreshold = 0.5;
    public static String result_true_duration = System.getProperty("user.dir") + "/result/result_" + dataset + "_true_duration.txt";
    public static String result_pre_duration_icq = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_duration_icq.txt";
//    public static String result_pre_duration_icq_base = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_duration_icqBase.txt";
    public static String result_pre_duration_icq_base_new = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_duration_icqBaseNew.txt";
    public static String result_pre_duration_icq_base_unseen = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_duration_icqBaseUnseen.txt";


    public static String outFilePrecision = System.getProperty("user.dir") + "/result/" + dataset + "_duration_precision.csv";
    public static String outFileRecall = System.getProperty("user.dir") + "/result/" + dataset + "_duration_recall.csv";
    public static String outFileF = System.getProperty("user.dir") + "/result/" + dataset + "_duration_F.csv";
...
//        PreCompute.preInfo_read(dataset, 4000, DataGenConstant.sample_dist);
        ...
        ArrayList<Integer> durations = new ArrayList<>(Arrays.asList(60, 120, 180, 240, 300, 360, 420, 480, 540, 600));
        String s = "";
        ...
        try {
            FileWriter output = new FileWriter(result_true_duration);
            output.write(s);
            output.flush();
            output.close();
        } catch (IOException e) {
    ...
    public static void calAccuracy() throws IOException {
        String resultPrecision = "duration" + "\t" + "icq" + "\t" + "icq_baseNew" + "icq_baseUnseen" + "\n";
        String resultRecall = "duration" + "\t" + "icq" + "\t" + "icq_baseNew" + "icq_baseUnseen" + "\n";
        String resultF = "duration" + "\t" + "icq" + "\t" + "icq_baseNew" + "icq_baseUnseen" + "\n";

        Path path = Paths.get(result_true_duration);
        Scanner scanner = new Scanner(path);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> duration_true_map = new HashMap<>();
        while (scanner.hasNextLine()) {
            String line = scanner.nextLine();
            String [] tempArr1 = line.split("\t");
            int duration = Integer.parseInt(tempArr1[0]);
            ...
            duration_true_map.put(duration, tra_map);
        }

        Path path1 = Paths.get(result_pre_duration_icq);
        Scanner scanner1 = new Scanner(path1);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> duration_icq_map = new HashMap<>();
        while (scanner1.hasNextLine()) {
            ...
            duration_icq_map.put(duration, tra_map);
        }

        Path path2 = Paths.get(result_pre_duration_icq_base_new);
        Scanner scanner2 = new Scanner(path2);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> duration_icqBaseNew_map = new HashMap<>();
        while (scanner2.hasNextLine()) {
            ...
            duration_icqBaseNew_map.put(duration, tra_map);
        }

        Path path3 = Paths.get(result_pre_duration_icq_base_unseen);
        Scanner scanner3 = new Scanner(path3);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> duration_icqBaseUnseen_map = new HashMap<>();
        while (scanner3.hasNextLine()) {
            ...
            duration_icqBaseUnseen_map.put(duration, tra_map);
        }
        ...
        for (int duration: durations) {
            resultF += duration;
            resultRecall += duration;
            resultPrecision += duration;
            ...
            HashMap<Integer, HashMap<Integer, Double>> tra_icq_map = duration_icq_map.get(duration);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseNew_map = duration_icqBaseNew_map.get(duration);
            HashMap<Integer, HashMap<Integer, Double>> tra_true_map = duration_true_map.get(duration);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseUnseen_map = duration_icqBaseUnseen_map.get(duration);
...
//                }
//                else {
//                    System.out.println("error sum2: " + error2);
//                    error2 = error2 / num2;
//                    System.out.println("error ave2: " + error2);
//                    acc2 = 1 - error2;
