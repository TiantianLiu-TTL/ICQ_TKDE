...
public class Acc_ObjectNum {
    static String dataset = "syn";

    static double probabilityThreshold = 0.5;
    static int objectNum = 8000;
    public static String result_true_objectNum = System.getProperty("user.dir") + "/result/result_" + dataset + "_true_objectNum.txt";
    public static String result_pre_objectNum_icq = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_objectNum_icq.txt";
//    public static String result_pre_objectNum_icq_base = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_objectNum_icqBase.txt";
    public static String result_pre_objectNum_icq_base_new = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_objectNum_icqBaseNew.txt";
    public static String result_pre_objectNum_icq_base_unseen = System.getProperty("user.dir") + "/result/result_" + dataset + "_pre_objectNum_icqBaseUnseen.txt";


    public static String outFilePrecision = System.getProperty("user.dir") + "/result/" + dataset + "_objectNum_precision.csv";
    public static String outFileRecall = System.getProperty("user.dir") + "/result/" + dataset + "_objectNum_recall.csv";
    public static String outFileF = System.getProperty("user.dir") + "/result/" + dataset + "_objectNum_F.csv";
    ...
    public static void getGroundTruth() throws IOException {
        ...
        TrajectoryGen.trajectoryGen_read(TrajectoryGen.trajectoryPoints, TrajectoryGen.trajectorys, dataset, objectNum, true);
//        PreCompute.preInfo_read(dataset, objectNum, DataGenConstant.sample_dist);
        ...
        for (int j = 0; j < trajectorys.size(); j++) {
            ...
            System.out.println("icq_baseline result: " + result0);
        ...
        try {
            FileWriter output = new FileWriter(result_true_objectNum, true);
            output.write(s);
            output.flush();
            output.close();
        } catch (IOException e) {
    ...
    public static void calAccuracy() throws IOException {
        String resultPrecision = "objectNum" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        String resultRecall = "objectNum" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";
        String resultF = "objectNum" + "\t" + "icq" + "\t" + "icq_baseNew" + "\t" + "icq_baseUnseen" + "\n";

        Path path = Paths.get(result_true_objectNum);
        Scanner scanner = new Scanner(path);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> objectNum_true_map = new HashMap<>();
        while (scanner.hasNextLine()) {
            String line = scanner.nextLine();
            String [] tempArr1 = line.split("\t");
            int objectNum = Integer.parseInt(tempArr1[0]);
            ...
            objectNum_true_map.put(objectNum, tra_map);
        }

        Path path1 = Paths.get(result_pre_objectNum_icq);
        Scanner scanner1 = new Scanner(path1);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> objectNum_icq_map = new HashMap<>();
        while (scanner1.hasNextLine()) {
            ...
            objectNum_icq_map.put(objectNum, tra_map);
        }

        Path path2 = Paths.get(result_pre_objectNum_icq_base_new);
        Scanner scanner2 = new Scanner(path2);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> objectNum_icqBaseNew_map = new HashMap<>();
        while (scanner2.hasNextLine()) {
            ...
            objectNum_icqBaseNew_map.put(objectNum, tra_map);
        }

        Path path3 = Paths.get(result_pre_objectNum_icq_base_unseen);
        Scanner scanner3 = new Scanner(path3);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, Double>>> objectNum_icqBaseUnseen_map = new HashMap<>();
        while (scanner3.hasNextLine()) {
            ...
            objectNum_icqBaseUnseen_map.put(objectNum, tra_map);
        }


        ArrayList<Integer> objectNums = new ArrayList<>(Arrays.asList(2000, 4000, 6000, 8000));

        for (int objectNum: objectNums) {
            resultF += objectNum;
            resultRecall += objectNum;
            resultPrecision += objectNum;
            ...
            HashMap<Integer, HashMap<Integer, Double>> tra_icq_map = objectNum_icq_map.get(objectNum);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseNew_map = objectNum_icqBaseNew_map.get(objectNum);
            HashMap<Integer, HashMap<Integer, Double>> tra_true_map = objectNum_true_map.get(objectNum);
            HashMap<Integer, HashMap<Integer, Double>> tra_icqBaseUnseen_map = objectNum_icqBaseUnseen_map.get(objectNum);
