...
public class Judge_baseline_new {
...
//            Uncertainty_baseline_new.preTrajectory.put(trajectory2.getTrajectoryId(), null);
            int result = 0;
...
//        System.out.println("start time: " + t);
            ...
            while (t <= trajectory1.getMaxTime() && t <= trajectory2.getMaxTime() && t <= eTime) {
                ...
                if (trajectoryPoints_tra1.get(t) != null) {
                    ...
                    traPointList1 = Uncertainty_baseline_new.preTrajectory.get(trajectory1.getTrajectoryId()).get(t);
                }
                ...
                if (trajectoryPoints_tra2.get(t) != null) {
                    ...
                    Uncertainty_baseline_new.findUncertainTra_forBaselineNew(trajectory2, t);
                    traPointList2 = Uncertainty_baseline_new.preTrajectory.get(trajectory2.getTrajectoryId()).get(t);
                }
